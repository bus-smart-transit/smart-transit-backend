...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create('trips', function (Blueprint $table) {
            ...
            $table->foreignId('driver_id')->nullable()->constrained('company_users', 'company_user_id');
            $table->foreignId('conductor_id')->nullable()->constrained('company_users', 'company_user_id');
